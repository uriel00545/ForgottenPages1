...
public class AreaController {
    ...
    private void configurarRecorteArea() {
        if (AreaCena == null) {
            return;
        }

        Rectangle clip = new Rectangle();
        clip.widthProperty().bind(AreaCena.widthProperty());
        clip.heightProperty().bind(AreaCena.heightProperty());
        AreaCena.setClip(clip);
    }
